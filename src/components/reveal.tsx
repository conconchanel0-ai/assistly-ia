...
interface CountUpProps {
  ...
  duration?: number;
  className?: string;
  /** Séparateur de milliers. À couper pour les années : 2013, pas 2 013. */
  grouping?: boolean;
}
...
export function CountUp({
    ...
    const observer = new IntersectionObserver(
      (entries) => {
        for (const entry of entries) {
          ...
          // Défilement rapide : le chiffre est déjà passé au-dessus de l'écran,
          // il doit afficher sa valeur plutôt que rester bloqué à zéro.
  ...
  }, [decimals, duration, grouping, prefix, suffix, value]);
