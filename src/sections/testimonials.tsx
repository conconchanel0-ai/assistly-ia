    ...
    >
      <div className="mt-6 grid gap-4 sm:mt-8 lg:grid-cols-[1.3fr_1fr] lg:items-end lg:gap-12">
        <Reveal as="h2" className="type-poster text-[clamp(2.4rem,10.5vw,7.5rem)] text-cream">
          <CountUp value={4.9} decimals={1} /> sur <CountUp value={38} /> avis
        </Reveal>
        <Reveal as="p" delay={90} className="type-editorial max-w-[56ch] text-[11.5px] text-cream/90 sm:text-[12.5px] lg:pb-3">
          Recueillis auprès des clients des quatre dernières saisons. Ceux qui font
          entretenir leur jardin reviennent d'une année sur l'autre : c'est la seule
          statistique qui m'intéresse vraiment.
        </Reveal>
      </div>
      ...
      <p className="mt-6 font-body text-[10px] font-semibold uppercase tracking-[0.16em] text-cream/55 sm:text-[11px]">
        Avis fictifs — site de démonstration
      </p>
    </Slide>
  );
}
